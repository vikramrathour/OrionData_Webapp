...
export const codeExamples = {
  ...
  withOrian: {
    ...
    lines: [
      ...
      { text: '# OrionDQ: join completeness assertion > 99.5%', type: 'comment-success' },
      { text: '', type: 'empty' },
      { text: 'df_joined = df_customers.join(', type: 'code' },
      { text: '    df_transactions,', type: 'code' },
    ...
    fixes: [
      ...
      'OrionDQ monitors production — catches drift before business impact',
    ],
  },
}
